...
const translations = {
    id: {
        ...
        proj_desc6: "Algoritma scalping otomatis di timeframe M5 menggunakan makro tren EMA 200 dan kondisi RSI.",
    ...
    en: {
        ...
        proj_desc6: "Automated scalping algorithm in M5 timeframe using EMA 200 macro trend and RSI conditions.",
    ...
    jp: {
        ...
        proj_desc6: "EMA 200およびRSIの条件を使用したM5タイムフレームでの自動スキャルピングアルゴリズム。",
