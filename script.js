...
const translations = {
    id: {
        ...
        proj_desc7: "Tool geoprocessing berbasis web untuk operasi spasial (merge, clip, union, buffer) langsung di browser. Mendukung upload data GeoJSON dan Shapefile ZIP, manajemen layer & symbology, serta beberapa pilihan basemap interaktif.",
    ...
    en: {
        ...
        proj_desc7: "Web-based geoprocessing tool for spatial operations (merge, clip, union, buffer) directly in the browser. Supports GeoJSON and Shapefile ZIP uploads, layer & symbology management, and multiple interactive basemaps.",
    ...
    jp: {
        ...
        proj_desc7: "ブラウザ上で直接空間操作（マージ、クリップ、ユニオン、バッファ）を行うためのWebベースの地理処理ツール。GeoJSONやShapefile ZIPのアップロード、レイヤーとシンボルの管理、複数のインタラクティブなベースマップをサポートします。",
    ...
    zh: {
        ...
        proj_desc7: "基于Web的地理处理工具，直接在浏览器中进行空间操作（合并、裁剪、联合、缓冲区）。支持上传 GeoJSON 和 Shapefile ZIP、图层与符号系统管理以及多种交互式底图。",
